    ...
    do {
        try {
            ...
            const paragraphs = userText
                .trim()
                .match(/[^\r\n]+((\r|\n|\r\n)[^\r\n]+)*/g);
            console.log(chalk.bold.green(`Text Contains ${characters} characters, ${words ? words.length : 0} words, ${sentences ? sentences.length : 0} sentences, and ${paragraphs ? paragraphs.length : 0} paragraphs.\n`));
        }
        catch (error) {
